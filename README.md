...
sprint 0: 
1.we have created private key and certificated and initialized them to our local server and also created database.
2.made several changes to index file that we have created
